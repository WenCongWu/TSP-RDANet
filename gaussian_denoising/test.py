...
def main():
    ...
    model_name = 'tsp_rdanet_color'           # set denoiser model, 'drunet_gray' | 'drunet_color'
    ...
    from models.network import TSP_RDANet as net
    ...
    for idx, img in enumerate(L_paths):
        ...
        logger.info('{:s} - PSNR: {:.3f} dB; SSIM: {:.4f}.'.format(img_name+ext, psnr, ssim))
    ...
    logger.info('Average PSNR/SSIM(RGB) - {} - PSNR: {:.3f} dB; SSIM: {:.4f}'.format(result_name, ave_psnr, ave_ssim))
